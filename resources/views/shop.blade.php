                        ...
                        @foreach ($brands as $brand)
                            <li class="list-item">
                                <span class="menu-link py-1">
                                    ...
                                    @if (in_array($brand->id,explode(',',$f_brands)))checked="checked"
                                    @endif/>
                                    {{$brand->name}}
                                </span>
                                <span class="text-right float-end">
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" id="pagesize" name="pagesize" style="margin-right:20px" name="total-number">
              <option value="12" {{$size==12?'selected':''}} selected>Show</option>
              <option value="24" {{$size==24?'selected':''}}>24</option>
              <option value="48" {{$size==48?'selected':''}}>48</option>
              <option value="102" {{$size==102?'selected':''}}>102</option>
            </select>
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" id="orderBy" name="orderBy" name="total-number">
                ...
                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                    <div class="pc__img-wrapper">
                        ...
                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                            ...
                            <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer" title="Add To Cart"> Add To Cart
                            </button>
                        </form>
                        @endif
                    </div>
        ...
        <div class="flex items-center justify-between flex-rap gap10 wgp-pagination">
